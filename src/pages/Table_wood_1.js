...
export default function Model({ Hover, Click, ...props }) {
  ...
  // const group = useRef()
  // const { nodes, materials } = useGLTF('https://github.com/Hangeol-Chang/Hangeol-chang.github.io/blob/main/assets/img/test/glb/table_wood_1.glb')
  return (
    <></>
    // <group 
...
// useGLTF.preload('https://github.com/Hangeol-Chang/Hangeol-chang.github.io/blob/main/assets/img/test/glb/table_wood_1.glb')
